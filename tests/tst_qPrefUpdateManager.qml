...
//TBD		compare(PrefUpdateManager.next_check,  x4_date)
	...
	Item {
		...
		Connections {
			...
			function onDont_check_for_updatesChanged() {spyCatcher.spy1 = true }
			function onLast_version_usedChanged() {spyCatcher.spy3 = true }
			function onNext_checkChanged() {spyCatcher.spy4 = true }
			function onUuidStringChanged() {spyCatcher.spy5 = true }
		}
	}
